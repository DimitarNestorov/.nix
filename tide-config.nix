{
  ...
  tide_node_icon = "";
  tide_os_bg_color = "333333";
  tide_os_color = "D6D6D6";
  tide_os_icon = "";
  ...
  tide_right_prompt_items = "status cmd_duration context jobs direnv node python rustc java php pulumi ruby go gcloud kubectl distrobox toolbox terraform aws nix_shell crystal elixir zig shlvl time";
