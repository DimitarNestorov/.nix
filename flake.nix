{
	...
	inputs = {
		...
		nixpkgs-ghostty.url = "github:nixos/nixpkgs/3187271a737d623ba3ebfa12ec3e8b66a0321542";
	...
	outputs = {
		...
		configuration = { system, type ? "personal" }: let
			...
			pkgs-ghostty = import inputs.nixpkgs-ghostty { inherit system; };
